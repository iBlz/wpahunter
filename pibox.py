...
while select not in ["1","2","3","4","5","6","7","x"]:
...
if select == "1":
    ...
    os.system("netstat -i")
    print("")
    interface = input(f"{Fore.WHITE}[{Fore.LIGHTBLUE_EX}q{Fore.WHITE}]{Fore.WHITE} Choose > {Fore.RED}")
    print("")
    ...
    time.sleep(2)
    os.system("airodump-ng -w out --output-format csv " + interface)
    os.system("clear")
    selectnet()
    rem()
...
if select == "3":
    ...
    os.system('airodump-ng --bssid %s -c %s -w out --output-format cap %s' % (bssid,channel,interface))
...
if select == "4":
    ...
    print("")
    print(f"{Fore.WHITE}[{Fore.LIGHTGREEN_EX}i{Fore.WHITE}] {Fore.GREEN}Converting to pcap format...")
    os.system("tcpdump -r out.pcapng -w out.pcap")
    print("")
    print(f"{Fore.WHITE}[{Fore.LIGHTGREEN_EX}i{Fore.WHITE}] {Fore.RED}Output file :")
...
if select == "5":
    ...
    print("")
    os.system("sudo airmon-ng start {} >> /dev/null".format(interface))
    print(f"{Fore.WHITE}[{Fore.LIGHTGREEN_EX}i{Fore.WHITE}] {Fore.WHITE}Monitor Mode Enabled on interface {Fore.RED}%s" % interface)
    print(f"{Fore.WHITE}[{Fore.LIGHTGREEN_EX}i{Fore.WHITE}] {Fore.GREEN}To stop CTRL + C{Fore.RESET}")
    time.sleep(2)
    os.system("airodump-ng -w out --output-format csv " + interface)
    print("")
...
if select == "6":
    ...
    selectnet()
    rem()
    os.system("airodump-ng --bssid %s -w out --output-format csv %s" % (bssid,interface))
    print("")
    print(f"{Fore.GREEN}WFW Script")
    print("")
    os.system("bash wfw.sh /root/out-01.csv")
